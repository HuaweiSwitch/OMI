...
MI_INLINE MI_Result MI_CALL Widget_Set_Array(
    Widget* self,
...
MI_INLINE MI_Result MI_CALL Widget_SetPtr_Array(
    Widget* self,
    const MI_Uint32* data,
    MI_Uint32 size)
{
...
MI_INLINE MI_Result MI_CALL Widget_Clear_Array(
    Widget* self)
{
    return self->__instance.ft->ClearElementAt(
        (MI_Instance*)&self->__instance,
