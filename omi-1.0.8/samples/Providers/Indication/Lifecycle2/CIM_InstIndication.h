...
MI_INLINE MI_Result MI_CALL CIM_InstIndication_Construct(
    ...
    MI_Context* context)
{
    return MI_ConstructInstance(context, &CIM_InstIndication_rtti,
        (MI_Instance*)&self->__instance);
}

MI_INLINE MI_Result MI_CALL CIM_InstIndication_Clone(
    const CIM_InstIndication* self,
    CIM_InstIndication** newInstance)
{
...
MI_INLINE MI_Result MI_CALL CIM_InstIndication_Destruct(CIM_InstIndication* self)
{
    return MI_Instance_Destruct(&self->__instance);
}

MI_INLINE MI_Result MI_CALL CIM_InstIndication_Delete(CIM_InstIndication* self)
{
