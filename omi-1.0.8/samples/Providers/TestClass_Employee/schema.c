...
static MI_CONST MI_PropertyDecl TestCIM_Error_errResult_prop =
{
    ...
    NULL, /* className */
    0, /* subscript */
    offsetof(TestCIM_Error, errResult), /* offset */
    MI_T("TestCIM_Error"), /* origin */
    MI_T("TestCIM_Error"), /* propagator */
    NULL,
};

static MI_PropertyDecl MI_CONST* MI_CONST TestCIM_Error_props[] =
{
    &CIM_Error_ErrorType_prop,
    &CIM_Error_OtherErrorType_prop,
    &CIM_Error_OwningEntity_prop,
    ...
    &CIM_Error_CIMStatusCode_prop,
    &CIM_Error_CIMStatusCodeDescription_prop,
    &TestCIM_Error_errResult_prop,
};

static MI_CONST MI_Boolean TestCIM_Error_Indication_qual_value = 1;

static MI_CONST MI_Qualifier TestCIM_Error_Indication_qual =
{
    MI_T("Indication"),
    MI_BOOLEAN,
    MI_FLAG_DISABLEOVERRIDE|MI_FLAG_TOSUBCLASS,
    &TestCIM_Error_Indication_qual_value
};

static MI_CONST MI_Boolean TestCIM_Error_Exception_qual_value = 1;

static MI_CONST MI_Qualifier TestCIM_Error_Exception_qual =
{
    MI_T("Exception"),
    MI_BOOLEAN,
    MI_FLAG_DISABLEOVERRIDE|MI_FLAG_TOSUBCLASS,
    &TestCIM_Error_Exception_qual_value
};

static MI_CONST MI_Char* TestCIM_Error_UMLPackagePath_qual_value = MI_T("CIM::Interop");

static MI_CONST MI_Qualifier TestCIM_Error_UMLPackagePath_qual =
{
    MI_T("UMLPackagePath"),
    MI_STRING,
    MI_FLAG_ENABLEOVERRIDE|MI_FLAG_TOSUBCLASS,
    &TestCIM_Error_UMLPackagePath_qual_value
};

static MI_CONST MI_Char* TestCIM_Error_Description_qual_value = MI_T("193");

static MI_CONST MI_Qualifier TestCIM_Error_Description_qual =
{
    MI_T("Description"),
    MI_STRING,
    MI_FLAG_ENABLEOVERRIDE|MI_FLAG_TOSUBCLASS|MI_FLAG_TRANSLATABLE,
    &TestCIM_Error_Description_qual_value
};

static MI_Qualifier MI_CONST* MI_CONST TestCIM_Error_quals[] =
{
    &TestCIM_Error_Indication_qual,
    &TestCIM_Error_Exception_qual,
    &TestCIM_Error_UMLPackagePath_qual,
    &TestCIM_Error_Description_qual,
};

/* class TestCIM_Error */
MI_CONST MI_ClassDecl TestCIM_Error_rtti =
{
    MI_FLAG_CLASS|MI_FLAG_INDICATION, /* flags */
    0x0074720D, /* code */
    MI_T("TestCIM_Error"), /* name */
    TestCIM_Error_quals, /* qualifiers */
    MI_COUNT(TestCIM_Error_quals), /* numQualifiers */
    TestCIM_Error_props, /* properties */
    MI_COUNT(TestCIM_Error_props), /* numProperties */
    sizeof(TestCIM_Error), /* size */
