    ...
    *indication = NULL;
    {
        ...
        r = MI_Context_NewInstance(context, &L_IndicationC2_rtti, indication);
        ...
        inst = (L_IndicationC2*) (*indication);
        r = L_IndicationC2_Set_message(inst, MI_T("test indication message"));
        CHKSETPROPERTY(r, "message");
        r = L_IndicationC2_Set_id(inst, config->count);
        CHKSETPROPERTY(r, "id");
        r = L_IndicationC2_Set_lcode2(inst, config->count);
        CHKSETPROPERTY(r, "lcode2");
...
void MI_CALL L_IndicationC2_Load(
    ...
    MI_Context* context)
{
    MI_Result r;
    *self = NULL;
    r = class_Load((void**)self, &cfgL_IndicationC2, _SetIndicationProperties);
    MI_PostResult(context, r);
}

void MI_CALL L_IndicationC2_Unload(
    L_IndicationC2_Self* self,
    MI_Context* context)
{
    MI_Result r = class_Unload((void*)self, &cfgL_IndicationC2);
    MI_PostResult(context, r);
}

void MI_CALL L_IndicationC2_EnableIndications(
    L_IndicationC2_Self* self,
    ...
    const MI_Char* className)
{
    ...
    /* NOTE:Call one of following functions if and ONLY if encount termination error,
            ...
            */
    MI_Result r = class_EnableIndications((void*)self, indicationsContext, &cfgL_IndicationC2, nameSpace, className);
    if (r != MI_RESULT_OK)
        MI_PostResult(indicationsContext, r);
}

void MI_CALL L_IndicationC2_DisableIndications(
    L_IndicationC2_Self* self,
    MI_Context* indicationsContext,
    const MI_Char* nameSpace,
    const MI_Char* className)
{
    MI_Result r = class_DisableIndications((void*)self, indicationsContext, &cfgL_IndicationC2, nameSpace, className);
    MI_PostResult(indicationsContext, r);
}

void MI_CALL L_IndicationC2_Subscribe(
    L_IndicationC2_Self* self,
    MI_Context* context,
    const MI_Char* nameSpace,
    const MI_Char* className,
    ...
    void** subscriptionSelf)
{
    ...
    /* NOTE:Call one of following functions if and ONLY if encount termination error,
            ...
            and Unsubscribe function will not be invoked then,
             ...
             MI_Context_PostCimError
            */
    MI_Result r = class_Subscribe((void*)self, context, &cfgL_IndicationC2, nameSpace, className, filter, bookmark, subscriptionID, subscriptionSelf);
    if (r != MI_RESULT_OK)
        MI_PostResult(context, r);
}

void MI_CALL L_IndicationC2_Unsubscribe(
    L_IndicationC2_Self* self,
    MI_Context* context,
    const MI_Char* nameSpace,
    const MI_Char* className,
    ...
    void* subscriptionSelf)
{
    MI_Result r = class_Unsubscribe((void*)self, context, &cfgL_IndicationC2, nameSpace, className, subscriptionID, subscriptionSelf);
    MI_PostResult(context, r);
}
