...
MI_INLINE MI_Result MI_CALL CIM_ComputerSystem_RequestStateChange_Construct(
    ...
    MI_Context* context)
{
    return MI_ConstructParameters(context, &CIM_ComputerSystem_RequestStateChange_rtti,
        (MI_Instance*)&self->__instance);
}

MI_INLINE MI_Result MI_CALL CIM_ComputerSystem_RequestStateChange_Clone(
    const CIM_ComputerSystem_RequestStateChange* self,
    CIM_ComputerSystem_RequestStateChange** newInstance)
{
    return MI_Instance_Clone(
        &self->__instance, (MI_Instance**)newInstance);
}
