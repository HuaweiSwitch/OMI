...
MI_INLINE MI_Result MI_CALL CIM_Service_Construct(
    ...
    MI_Context* context)
{
    return MI_ConstructInstance(context, &CIM_Service_rtti,
        (MI_Instance*)&self->__instance);
}

MI_INLINE MI_Result MI_CALL CIM_Service_Clone(
    const CIM_Service* self,
    CIM_Service** newInstance)
{
...
MI_INLINE MI_Result MI_CALL CIM_Service_Destruct(CIM_Service* self)
{
    return MI_Instance_Destruct(&self->__instance);
}

MI_INLINE MI_Result MI_CALL CIM_Service_Delete(CIM_Service* self)
{
...
MI_INLINE MI_Result MI_CALL CIM_Service_RequestStateChange_Set_MIReturn(
    CIM_Service_RequestStateChange* self,
    MI_Uint32 x)
{
...
MI_INLINE MI_Result MI_CALL CIM_Service_StartService_Construct(
    CIM_Service_StartService* self,
    MI_Context* context)
{
    return MI_ConstructParameters(context, &CIM_Service_StartService_rtti,
        (MI_Instance*)&self->__instance);
}

MI_INLINE MI_Result MI_CALL CIM_Service_StartService_Clone(
    const CIM_Service_StartService* self,
    CIM_Service_StartService** newInstance)
{
    return MI_Instance_Clone(
        &self->__instance, (MI_Instance**)newInstance);
}
...
MI_INLINE MI_Result MI_CALL CIM_Service_StopService_Construct(
    CIM_Service_StopService* self,
    MI_Context* context)
{
    return MI_ConstructParameters(context, &CIM_Service_StopService_rtti,
        (MI_Instance*)&self->__instance);
}

MI_INLINE MI_Result MI_CALL CIM_Service_StopService_Clone(
    const CIM_Service_StopService* self,
    CIM_Service_StopService** newInstance)
{
    return MI_Instance_Clone(
        &self->__instance, (MI_Instance**)newInstance);
}
