...
MI_INLINE MI_Result MI_CALL CIM_SettingData_Construct(
    ...
    MI_Context* context)
{
    return MI_ConstructInstance(context, &CIM_SettingData_rtti,
        (MI_Instance*)&self->__instance);
}

MI_INLINE MI_Result MI_CALL CIM_SettingData_Clone(
    const CIM_SettingData* self,
    CIM_SettingData** newInstance)
{
...
MI_INLINE MI_Result MI_CALL CIM_SettingData_Destruct(CIM_SettingData* self)
{
    return MI_Instance_Destruct(&self->__instance);
}

MI_INLINE MI_Result MI_CALL CIM_SettingData_Delete(CIM_SettingData* self)
{
